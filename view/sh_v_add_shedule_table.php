...
jQuery(function($){
        ...
        $( "#sh_datepicker_start" ).datepicker({
            <?php if(!empty($_POST['sh_table_date_begin'])): ?>
            defaultDate : '<?php echo $_POST["sh_table_date_begin"];?>',
            <?php endif;?>
        ...
        $( "#sh_datepicker_end" ).datepicker({
            <?php if(!empty($_POST['sh_table_date_begin'])): ?>
            defaultDate : '<?php echo $_POST["sh_table_date_end"];?>',
            <?php endif;?>
            onSelect: function(dateText){
...
<div class="wrap">
    ...
    <form action="admin.php?page=sh_shedule_table&action=create" method="post">
        <div id="poststuff">
            <div id="post-body" class="metabox-holder columns-2">
                <div id="post-body-content">
                    ...
                    <div id="titlediv">
                        <div id="titlewrap">
                            <label class="<?php echo empty($_POST['sh_table_title']) ? '' : 'screen-reader-text'?>" id="title-prompt-text" for="title"><?php _e('Enter a title', 'shedule');?></label>
                                <input type="text" name="sh_table_title" size="30" value="<?php if(isset($_POST['sh_table_title'])) echo $_POST['sh_table_title']?>" id="title" autocomplete="off">
                        </div>                        
                    </div>
                    <?php wp_editor((empty($_POST['sh_table_desc']) ? '' : $_POST['sh_table_desc']), 'sh_table_desc', array(
                        'wpautop'=>1, 
                        'media_buttons'=>0,
                ...
                <div id="postbox-container-1" class="postbox-container">
                    <div id="side-sortables" class="meta-box-sortables ui-sortable">
                        ...
                        <div id="sh_date_start" class="postbox">
                            ...
                            <div class="inside">
                                <input type="hidden" id="sh_shedule_date_start" name="sh_table_date_begin" value="<?php if(isset($_POST['sh_table_date_begin'])) echo $_POST['sh_table_date_begin']?>"/>
                        ...
                        <div id="sh_date_end" class="postbox">
                            ...
                            <div class="inside">
                                <input type="hidden" id="sh_shedule_date_end" name="sh_table_date_end" value="<?php if(isset($_POST['sh_table_date_end'])) echo $_POST['sh_table_date_end']?>"/>
                        ...
                        <div id="sh_labels" class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <?php if(!empty($_POST['sh_table_labels'])):?>
                                <?php foreach($_POST['sh_table_labels'] as $key=>$value):?>
                                    <div>
